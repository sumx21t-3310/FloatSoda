...
using FloatSoda.OVR;
using FloatSoda.Samples.Padding;
...
{
    AppKey = new AppKey("FloatSoda.Samples.Padding"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new PaddingDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "Padding", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "Padding", Child = demo });
