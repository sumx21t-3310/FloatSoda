...
using FloatSoda.OVR;
using FloatSoda.Samples.OverflowBox;
...
{
    AppKey = new AppKey("FloatSoda.Samples.OverflowBox"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new OverflowBoxDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "OverflowBox", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "OverflowBox", Child = demo });
