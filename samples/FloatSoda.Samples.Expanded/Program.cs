...
using FloatSoda.OVR;
using FloatSoda.Samples.Expanded;
...
{
    AppKey = new AppKey("FloatSoda.Samples.Expanded"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new ExpandedDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "Expanded", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "Expanded", Child = demo });
