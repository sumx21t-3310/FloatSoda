...
using FloatSoda.OVR;
using FloatSoda.Samples.ConstraintsTransformBox;
...
{
    AppKey = new AppKey("FloatSoda.Samples.ConstraintsTransformBox"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new ConstraintsTransformBoxDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "ConstraintsTransformBox", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "ConstraintsTransformBox", Child = demo });
