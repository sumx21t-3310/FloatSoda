...
using FloatSoda.OVR;
using FloatSoda.Samples.FittedBox;
...
{
    AppKey = new AppKey("FloatSoda.Samples.FittedBox"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new FittedBoxDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "FittedBox", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "FittedBox", Child = demo });
