...
{
    AppKey = new AppKey("FloatSoda.Samples.Wrap"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new WrapDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "Wrap", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "Wrap", Child = demo });
