...
using FloatSoda.OVR;
using FloatSoda.Samples.Transform;
...
{
    AppKey = new AppKey("FloatSoda.Samples.Transform"),
});

using var host = builder.Build();
var app = host.Services.GetRequiredService<FloatSodaApp>();

var demo = new TransformDemo();

app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "Transform", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "Transform", Child = demo });
