...
{
    AppKey = new AppKey("FloatSoda.Samples.Text"),
});
...
app.CreateWindow(useDesktop
    ? new DesktopWindow { Title = "Text", Child = demo }
    : new DashboardWindow { Dpm = new Dpm(1000), Title = "Text", Child = demo });
