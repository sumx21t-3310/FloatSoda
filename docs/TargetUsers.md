...
作れるものの例(FloatSoda は現在 Phase 1(入力基盤)を開発中で、以下はロードマップ上の予定です。各 Phase の詳細は [GitHub のマイルストーン](https://github.com/sumx21t-3310/FloatSoda/milestones) を参照):
...
| VRChat の写真フォルダを VR 内で眺めるアルバム | 画像グリッド + スクロール | Phase 3(スクロールと画像) |
